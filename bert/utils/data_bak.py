            ...
            if prob < 0.8:
                ...
                for j in range(span_len):
                    while True:
                        ...
                        if rdi not in [vocab.get(CLS_TOKEN), vocab.get(SEP_TOKEN), vocab.get(MASK_TOKEN), vocab.get(PAD_TOKEN)]:
                            break
                    src[i+j] = rdi
        else:
            i = index_set[0]
        ...
        while True:
            ...
            for ins in instances:
                if len(ins) == 4:
                    ...
                    seg.append([1]*ins[3][0] + [2]*(ins[3][1]-ins[3][0]) + [self.vocab.get(PAD_TOKEN)]*(len(ins[0])-ins[3][1]))
                else:
                    ...
                    seg.append([1]*ins[2][0] + [2]*(ins[2][1]-ins[2][0]) + [self.vocab.get(PAD_TOKEN)]*(len(ins[0])-ins[2][1]))
