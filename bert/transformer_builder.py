...
from bert.models.pegasus_model import PegasusModel
...
def build_model(args):
    ...
    model = PegasusModel(args, src_embedding, tgt_embedding, encoder, decoder, target, args.vocab.get(START_TOKEN),
